...
export const Hero = () => {
  ...
  const { validateCheatCode } = useCheatcode();

  const handleCheatCode = () => {
    let ans = validateCheatCode(myCode);
    ans
    ...
    <div className="flex md:flex-row flex-col md:p-10 p-1 md:mt-8 mt-10 justify-between items-center">
      <div className="flex flex-col md:w-4xl">
        ...
        <div className="flex flex-wrap text-center gap-4 items-center mt-5">
          <a
            href="https://github.com/thakur06"
            target="_blank"
            className="flex flex-row items-center gap-2 border-b border-white/10 px-2 py-1 cursor-pointer"
          >
            <FaGithub color="grey" size={18} />
            <span>Github</span>
          </a>
          <a
            href="https://www.linkedin.com/in/abhishek-rajput007"
            target="_blank"
            className="flex flex-row items-center gap-2 border-b border-white/10 px-2 py-1 cursor-pointer"
          >
          ...
          <a
            href="https://leetcode.com/u/ar497477/"
            target="_blank"
            className="flex flex-row items-center gap-2 border-b border-white/10 px-2 py-1 cursor-pointer"
          >
        ...
        <div className="flex flex-row items-center  mt-5 gap-4">
          <div className="w-full  max-w-[200px]">
            <div className="relative">
              <input
                placeholder="Activate cheat code"
                onChange={(e) => {
                  e.preventDefault();
                  setmyCode(e.target.value);
                }}
                className="peer w-full bg-transparent placeholder:text-gray-200 text-green-700 text-sm border border-slate-200 rounded-md px-3 py-1 transition duration-300 ease focus:outline-none focus:border-slate-400 hover:border-slate-300 shadow-sm focus:shadow"
              />
            </div>
          </div>
          ...
          <button
            ...
            className=" w-fit relative px-1 py-1 overflow-hidden cursor-pointer  text-white bg-green-700 border border-gray-100 rounded-lg shadow-inner group text-sm h-8"
          >
...
transition={Bounce}/>
      ...
      <div className="w-full h-auto aspect-[1.4/1] max-w-screen-lg mx-auto md:w-4/5 lg:w-3/5">
        ...
        >
          <defs>
            ...
            >
              ...
              <stop offset="0.93102" stopColor="#26312d">
                <animate
                  attributeName="stopColor"
                  values="#26312d;#27b173;#1a663f;#26312d"
                  dur="17s"
                  repeatCount="indefinite"
                />
              </stop>
          ...
          <path
            d="M318.587 315.483V510.936L477.544 431.391V236.949M318.587 315.483L477.544 236.949M318.587 315.483V509.925L159.63 589.469M477.544 236.949L318.587 158.753L159.63 236.949M477.544 236.949V432.402M477.544 236.949L318.587 158.416L477.544 80.2192L636.5 158.416L477.544 236.949Z"
            stroke="url(#paint-linear)"
            strokeWidth="2"
            strokeOpacity="0.8"
            filter="url(#glow)"
          ...
          <path
            d="M795.457 395.701V237.286M795.457 237.286L636.5 159.09L477.544 237.286M795.457 237.286L636.5 315.82M477.544 237.286V431.728L601.139 491.762M477.544 237.286L636.5 315.82M636.5 315.82V472.887"
            stroke="url(#paint-linear)"
            strokeWidth="2"
            strokeOpacity="0.8"
            filter="url(#glow)"
          ...
          <path
            d="M954.414 668.003V473.561M954.414 473.561L795.457 395.364L636.5 473.561L795.457 552.094M954.414 473.561L795.457 552.094M954.414 473.561V669.014M954.414 473.561L795.457 395.027L954.414 316.831L1113.37 395.027L954.414 473.561Z"
            stroke="url(#paint-linear)"
            strokeWidth="2"
            strokeOpacity="0.8"
            filter="url(#glow)"
          ...
          <path
            d="M795.457 552.094L636.5 473.898L477.544 552.094M795.457 552.094L636.5 630.628M477.544 552.094V746.534L636.5 826.078V630.628M477.544 552.094L636.5 630.628M795.457 709.498V904.949M795.457 709.498L636.5 630.965M795.457 709.498L954.414 630.965M795.457 904.949L954.414 825.404V630.965M795.457 904.949L636.5 825.404V630.965M636.5 630.965L795.457 552.768L954.414 630.965"
            stroke="url(#paint-linear)"
            strokeWidth="2"
            strokeOpacity="0.8"
            filter="url(#glow)"
          ...
          <path
            d="M1113.37 552.431V747.882M1113.37 552.431L954.414 473.898M1113.37 552.431L1272.33 473.898M1113.37 747.882L1272.33 668.34V473.898M1113.37 747.882L954.414 668.34V473.898M954.414 473.898L1113.37 395.701L1272.33 473.898"
            stroke="url(#paint-linear)"
            strokeWidth="2"
            strokeOpacity="0.8"
            filter="url(#glow)"

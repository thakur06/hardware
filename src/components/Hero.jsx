...
<div className="flex flex-wrap text-center gap-4 items-center mt-5">
  <a href='https://github.com/thakur06' target='_blank' className="flex flex-row items-center gap-2 border-b border-white/10 px-2 py-1 cursor-pointer">
    <FaGithub color="grey" size={18} />
    <span>Github</span>
  </a>
  <a href='https://www.linkedin.com/in/abhishek-rajput007' target='_blank' className="flex flex-row items-center gap-2 border-b border-white/10 px-2 py-1 cursor-pointer">
    <FaLinkedin color="grey" size={18} />
    <span>LinkedIn</span>
  </a>
  <a href='https://leetcode.com/u/ar497477/' target='_blank' className="flex flex-row items-center gap-2 border-b border-white/10 px-2 py-1 cursor-pointer">
